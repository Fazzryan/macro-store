                    ...
                    <div class="card py-3 px-4 border-0 shadow-1 rounded-16" style="margin-bottom: 140px;">
                        <div class="row mb-3 justify-content-between align-items-center">
                            ...
                            <div class="col-4 text-end ">
                                <a href="alamat.php" class="btn btn-gray fw-500 fs-15">Kembali</a>
                            </div>
                        </div>
                        <form action="" method="post">
                            <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3 mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="label_alamat" id="label_alamat" class="form-control" maxlength="20" required autocomplete="off">
                                </div>
                                <div class="col">
                                    <label for="catatan" class="fw-500 mb-2">Catatan untuk kurir (opsional)</label>
                                    <input type="text" name="catatan" id="catatan" class="form-control" maxlength="60" autocomplete="off">
                            ...
                            <div class="row row-cols-1 g-2 g-lg-3 mb-3">
                                <div class="col">
                                    ...
                                    <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap" cols="30" rows="10" autocomplete="off" maxlength="200" required></textarea>
                                </div>
                            </div>
                            <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3 mb-3">
                                <div class="col">
                                    <label for="penerima" class="fw-500 mb-2">Nama Penerima</label>
                                    <input type="text" name="penerima" id="penerima" class="form-control" maxlength="30" autocomplete="off" required>
                                </div>
                                <div class="col">
                                    <label for="nohp_penerima" class="fw-500 mb-1">Nomor HP</label>
                                    <input type="number" name="nohp_penerima" id="nohp_penerima" class="form-control" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" name="simpan_alamat" class="btn btn-green fw-500 w-100 d-lg-none d-block">Simpan</button>
                                <button type="submit" name="simpan_alamat" class="btn btn-green fw-500 w-50 d-none d-lg-inline">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
